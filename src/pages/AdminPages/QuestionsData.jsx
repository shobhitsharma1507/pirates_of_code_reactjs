    ...
    if (isNewQuestion) {
      ...
      if (category && questionTypeObj && chapter) {
        chapter.questions.push({
          ...updatedQuestion,
          options: updatedQuestion.options.split(",").map((opt) => opt.trim()),
          answer: updatedQuestion.answer.split(",").map((ans) => ans.trim()),
          tags: updatedQuestion.tags.split(",").map((tag) => tag.trim()),
          hints: updatedQuestion.hints.split("|").map((hint) => hint.trim()),
        });
      }
      ...
      const updatedData = data.map((category) => ({
        ...category,
        questionTypes: category.questionTypes.map((questionTypeObj) => ({
          ...questionTypeObj,
